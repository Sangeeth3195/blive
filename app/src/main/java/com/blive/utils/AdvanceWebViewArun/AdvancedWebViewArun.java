...
public class AdvancedWebViewArun extends WebView {
    ...
    public AdvancedWebViewArun(Context context) {
        super(context);
        init(context);
    }

    public AdvancedWebViewArun(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AdvancedWebViewArun(Context context, AttributeSet attrs, int defStyleAttr) {
...
*/
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        ...
        // if the download manager app has been disabled on the device
            ...
            openAppSettings(context, AdvancedWebViewArun.PACKAGE_NAME_DOWNLOAD_MANAGER);
