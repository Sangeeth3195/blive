...
public class FragmentHour extends BaseFragment implements AdapterLocal.Listener {
    ...
    private ArrayList<User> hourlyUsers = new ArrayList<>();
    ...
    private void initUI() {
        ...
        swipeRefreshLayout = mActivity.findViewById(R.id.swipeRefreshHour);
        ...
        if (utils.isNetworkAvailable()) {
            ...
            call.enqueue(new retrofit2.Callback<LeaderBoardResponse>() {
                ...
                public void onResponse(@NonNull Call<LeaderBoardResponse> call, @NonNull Response<LeaderBoardResponse> response) {
                    ...
                    Log.i("autolog", "leaderBoardResponse: " + response.raw().request().url());
                    if (leaderBoardResponse != null) {
                        if (leaderBoardResponse.getStatus().equalsIgnoreCase("success")) {
                            Log.e(TAG, "onResponse: " + leaderBoardResponse.toString());
    ...
    private void setData(ArrayList<User> mHourlyUsers) {
        ...
        if (hourlyUsers.size() > 0) {
            ...
            if (size < 4) {
                ...
                Log.e(TAG, "onChannelJoinSuccess: " + hourlyUsers.size());
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_this_hour, container, false);
    }
