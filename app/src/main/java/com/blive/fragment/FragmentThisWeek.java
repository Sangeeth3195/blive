...
/**
 * Created by sans on 23-08-2018.
 **/

public class FragmentThisWeek extends BaseFragment implements AdapterLocal.Listener {
    ...
    private void initUI() {
        ...
        swipeRefreshLayout = mActivity.findViewById(R.id.swipeRefreshWeek);
