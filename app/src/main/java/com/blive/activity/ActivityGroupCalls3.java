...
import com.blive.agora.GridVideoViewContainer3;
...
public class ActivityGroupCalls3 extends BaseActivity implements AGEventHandler, AdapterGiftGRP.ListenerGift,
    ...
    private ImageView ivUserProfileffect;
    protected Context context;
    private GridVideoViewContainer3 mGridVideoViewContainer3;
    ...
    private LinearLayout llChat, llNormalGift, llGift, ll_current_diamond, llUnFollow, llFollow, llKickOut;
    ...
    private boolean isFirst = false, isLiked = false, isClose = false, isSwiped = false, isSwipedDown = false, isArrived = false, isBroadcastEnded = false,
            ...
            isGiftSelected = false, isGuest1 = false, isGuest2 = false, isEntranceEffects = false, flag = false, isGuestVideoMuted = false, isGuestMutedThread = false, isCallRequested = false,
            isRefreshing = false, isUserListEnd = false, isAPICalled = false, isGuestRequest = false, isBroadcasterMuted = false, isDiamondPurchase = false,
            isAcceptRequest = true, isThisGuest1 = false, isThisGuest2 = false, isProfileShowing = false, isGuestAvailable = false, isBroadcasterOffline = true,
    ...
    private TextView tv_count_req, tvNoRequests, tvAssets, tvGift, tvCount, tvGiftName, tvDiamondValue, tvNoContributors, tvGuestName,
            tvGuestLevel, tvGuestGold, tvNoFriendsList, tvBliveId, tvMoonLevelCount, tvGiftsList, tvAssetsList, tvFreeGiftsList, tvOffline, tvStarLevel, count_tv;
    ...
    private ImageView ivGiftItem, iv, ivGuestProfile, ivOffline;
    ...
    private Audience guestOne, guestTwo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_calls3);
    ...
    protected void onResume() {
        ...
        if (!isCreated) {
            if (isGuest) {
                ...
                rlBroadcasterMute.setVisibility(View.GONE);
    ...
    protected void initUI() {
        ...
        mGridVideoViewContainer3 = findViewById(R.id.grid_video_view_container3);
        ...
        if (isBroadcaster(cRole)) {
            ...
            mGridVideoViewContainer3.initViewContainer(getApplicationContext(), SessionUser.getUser().getId(), mUidsList, true, isBroadcaster, guests);// first is now full view
        ...
        root.setOnTouchListener(new View.OnTouchListener() {
            ...
            private GestureDetector gestureDetector = new GestureDetector(ActivityGroupCalls3.this, new GestureDetector.SimpleOnGestureListener() {
        ...
        if (!isFirst) {
            ...
            if (utils.isNetworkAvailable()) {
                ...
                Call<GiftResponse> call = apiClient.getGifts("groupof3", SessionUser.getUser().getUser_id());
    ...
    private void callRemoveImageAPI() {
        ...
        if (isBroadcastEnded) {
            ...
            utils.hideProgress();
            Intent intent = new Intent(ActivityGroupCalls3.this, ActivityBroadcastStop.class);
...
//                runOnUiThread(this::callAPIOffline);
    ...
    private void switchToDefaultVideoView(ArrayList<Audience> guests) {
        ...
        mGridVideoViewContainer3.initViewContainer(getApplicationContext(), broadcaster.getId(), mUidsList, false, isBroadcaster, guests);
...
//                                showToast(getString(R.string.send_msg_failed));
    ...
    private void callAlertKickOut() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ActivityGroupCalls3.this);
    ...
    class LikeAnimationViewProvider implements LikeAnimationView.Provider {
        ...
        public Bitmap getBitmap(Object obj) {
            return ActivityGroupCalls3.this.mAnimationItemList == null ? null : (Bitmap) ActivityGroupCalls3.this.mAnimationItemList.get((Integer) obj);
        }
    }
    ...
    public void showActiveViewers() {
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(ActivityGroupCalls3.this);
    ...
    private void callStatusAPI() {
        if (utils.isNetworkAvailable()) {
           ...
           /* if (totalBroadcastSeconds > broadcastSeconds) {
                broadcastSeconds = totalBroadcastSeconds;
            }

            if (totalBroadcastSeconds ==0 && idelSeconds==0 && broadcastSeconds > 0) {
                totalBroadcastSeconds =  broadcastSeconds ;
            }

            if (idelSeconds > broadcastSeconds) {
                broadcastSeconds = idelSeconds;
            }*/

            utils.showProgress();

            final ApiInterface apiClient = ApiClientBase.getClient().create(ApiInterface.class);
            Call<GenericResponse> call = apiClient.goLive(SessionUser.getUser().getUser_id(), "INACTIVE", "groupof3",
...
//                                showToast(genericResponse.getData().getMessage());
    ...
    public void showAlertViewProfile(Audience audience, boolean isBroadcaster) {
        if (!SessionUser.getUser().getUser_id().equals(audience.getUser_id())) {
            ...
            rlReport.setOnClickListener(v -> {
                ...
                LayoutInflater layoutInflater = LayoutInflater.from(ActivityGroupCalls3.this);
                final View dialogView = layoutInflater.inflate(R.layout.pop_up_report, null);
                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ActivityGroupCalls3.this);
            ...
            llTopFans.setOnClickListener(v -> {
                Intent intent = new Intent(ActivityGroupCalls3.this, ActivityTopFans.class);
    ...
    public void gotoProfile(String image, String userId) {
        Intent intent = new Intent(ActivityGroupCalls3.this, ActivityViewProfile.class);
        intent.putExtra("image", image);
...
//        }
    ...
    public void loadGuestDetails(ArrayList<Audience> users) {
        ...
        if (users.size() > 0) {
            Log.e(TAG, "loadGuestDetails: " + users.size());
            if (isBroadcaster) {
                ivEndBroadcast.setVisibility(View.GONE);
                ivEndBroadcast.setVisibility(View.GONE);
            ...
            if (users.size() == 1) {
                ...
                Log.e(TAG, "loadGuestDetails : Size 1 ");
    ...
    public void onClickShare(View view) {
        fabMenu.close(true);
        showSharingDialog(ActivityGroupCalls3.this);
    }
...
//                                "\"iOS: https://apps.apple.com/us/app/blive24hrs/id1459884150\n" +
    ...
    public void showNotification() {
        notificationManager = NotificationManagerCompat.from(ActivityGroupCalls3.this);
        createNotificationChannel();

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {

            mBuilder = new NotificationCompat.Builder(ActivityGroupCalls3.this, CHANNEL_ID)
            ...
            mBuilder = new NotificationCompat.Builder(ActivityGroupCalls3.this)
                    .setSmallIcon(R.mipmap.ic_launcher)
                    .setContentTitle("Broadcast Still Streaming ")
                    .setStyle(new NotificationCompat.BigTextStyle()
                            .bigText("Your broadcast has paused!"))
