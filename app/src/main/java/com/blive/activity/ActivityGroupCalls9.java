...
import com.blive.agora.GridVideoViewContainer9;
...
public class ActivityGroupCalls9 extends BaseActivity implements AGEventHandler, AdapterGiftGRP.ListenerGift,
    ...
    @BindView(R.id.five_guest)
    FrameLayout flGuestFiveFrame;
    @BindView(R.id.sixth_guest)
    FrameLayout flGuestSixFrame;
    @BindView(R.id.seventh_guest)
    FrameLayout flGuestSevenFrame;
    @BindView(R.id.fl_GuestEight)
    FrameLayout flGuestEightFrame;
    ...
    @BindView(R.id.tv_guest_six_gold)
    TextView tvGuestSixGold;
    @BindView(R.id.tv_guest_seven_gold)
    TextView tvGuestSevenGold;
    @BindView(R.id.tv_guest_eight_gold)
    TextView tvGuestEightGold;
    ...
    @BindView(R.id.rl_guest_six_gold_status)
    RelativeLayout rlGuestSixGoldLayout;
    @BindView(R.id.rl_guest_seven_gold_status)
    RelativeLayout rlGuestSevenGoldLayout;
    @BindView(R.id.rl_guest_eight_gold_status)
    RelativeLayout rlGuestEightGoldLayout;
    ...
    @BindView(R.id.rl_videoMuteBroadcaterr)
    ...
    @BindView(R.id.rl_videoMute6)
    RelativeLayout rlGuestSixMute;
    @BindView(R.id.rl_videoMute7)
    RelativeLayout rlGuestSevenMute;
    @BindView(R.id.rl_videoMute8)
    RelativeLayout rlGuestEightMute;
    ...
    @BindView(R.id.iv_guest_six_small_gift)
    ImageView ivGuestSixSmallGift;
    @BindView(R.id.iv_guest_seven_small_gift)
    ImageView ivGuestSevenSmallGift;
    @BindView(R.id.iv_guest_eight_small_gift)
    ImageView ivGuestEightSmallGift;
    ...
    @BindView(R.id.tv_connecting_guest_six)
    TextView tvConnectingguestSix;
    @BindView(R.id.tv_connecting_guest_seven)
    TextView tvConnectingguestSeven;
    @BindView(R.id.tv_connecting_guest_eight)
    TextView tvConnectingguestEight;
    ...
    private GridVideoViewContainer9 mGridVideoViewContainer9;
    ...
    private boolean isFirst = false, isLiked = false, isClose = false, isSwiped = false, isSwipedDown = false, isArrived = false, isBroadcastEnded = false,
            ...
            isGiftSelected = false, isGuest1 = false, isGuest2 = false, isGuest3 = false, isGuest4 = false, isGuest5 = false, isGuest6 = false, isGuest7 = false, isGuest8 = false, isEntranceEffects = false, flag = false, isGuestVideoMuted = false, isGuestMutedThread = false,
            isCallRequested = false, isRefreshing = false, isUserListEnd = false, isAPICalled = false, isGuestRequest = false, isBroadcasterMuted = false,
            isDiamondPurchase = false, isAcceptRequest = true, isThisGuest1 = false, isThisGuest2 = false, isThisGuest3 = false, isThisGuest4 = false,
            isThisGuest5 = false, isThisGuest6 = false, isThisGuest7 = false, isThisGuest8 = false, isProfileShowing = false, isGuestAvailable = false,
            isBroadcasterOffline = true, isCallEnd = false, isClickedProfile = false, isFollowingFrMessage = false, isAudienceFollowing = false;
    ...
    private Audience guestOne, guestTwo, guestThree, guestFour, guestFive, guestSix, guestSeven, guestEight;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_call9);
    ...
    protected void initUI() {
            ...
            public void onMemberJoined(RtmChannelMember rtmChannelMember) {
                runOnUiThread(() -> {
                    if (isBroadcaster) {
                        ...
                        if (isGuestVideoMuted)
                            new Handler().postDelayed(() -> sendChannelMessage(SessionUser.getUser().getUser_id() + level + SessionUser.getUser().getName() + " GuestSix Muted"), 2000);
                    } else if (isGuest7) {
                        if (isGuestVideoMuted)
                            new Handler().postDelayed(() -> sendChannelMessage(SessionUser.getUser().getUser_id() + level + SessionUser.getUser().getName() + " GuestSeven Muted"), 2000);
                    } else if (isGuest8) {
                        if (isGuestVideoMuted)
                            new Handler().postDelayed(() -> sendChannelMessage(SessionUser.getUser().getUser_id() + level + SessionUser.getUser().getName() + " GuestEight Muted"), 2000);
                    }
                });
            }
        ...
        rlVideoMutes.add(rlGuestSixMute);
        rlVideoMutes.add(rlGuestSevenMute);
        rlVideoMutes.add(rlGuestEightMute);
        ...
        mGridVideoViewContainer9 = findViewById(R.id.grid_video_view_container9);
        ...
        if (isBroadcaster(cRole)) {
            ...
            mGridVideoViewContainer9.initViewContainer(getApplicationContext(), SessionUser.getUser().getId(), mUidsList, true, isBroadcaster, guests);// first is now full view
        ...
        root.setOnTouchListener(new View.OnTouchListener() {
            ...
            private GestureDetector gestureDetector = new GestureDetector(ActivityGroupCalls9.this, new GestureDetector.SimpleOnGestureListener() {
        ...
        if (!isFirst) {
            ...
            if (utils.isNetworkAvailable()) {
                ...
                Call<GiftResponse> call = apiClient.getGifts("groupof9",SessionUser.getUser().getUser_id());
        ...
        if (utils.isNetworkAvailable()) {
            if (isBroadcasterRemove) {
                switch (i) {
                    ...
                    case 6:
                        rlGuestSixGoldLayout.setVisibility(View.GONE);
                        sendChannelMessage(removeGuestId + level + SessionUser.getUser().getName() + " Guest Six Removed");
                        rlGuestSixMute.setVisibility(View.GONE);
                        break;
                    case 7:
                        rlGuestSevenGoldLayout.setVisibility(View.GONE);
                        sendChannelMessage(removeGuestId + level + SessionUser.getUser().getName() + " Guest Seven Removed");
                        rlGuestSevenMute.setVisibility(View.GONE);
                        break;
                    case 8:
                        rlGuestEightGoldLayout.setVisibility(View.GONE);
                        sendChannelMessage(removeGuestId + level + SessionUser.getUser().getName() + " Guest Eight Removed");
                        rlGuestEightMute.setVisibility(View.GONE);
                        break;
                }
                ...
                switch (i) {
                    ...
                    case 6:
                        rlGuestSixGoldLayout.setVisibility(View.GONE);
                        sendChannelMessage(removeGuestId + level + SessionUser.getUser().getName() + " Guest Six Left the Broadcast");
                        rlGuestSixMute.setVisibility(View.GONE);
                        clicked = false;
                    ...
                    case 7:
                        rlGuestSevenGoldLayout.setVisibility(View.GONE);
                        sendChannelMessage(removeGuestId + level + SessionUser.getUser().getName() + " Guest Seven Left the Broadcast");
                        rlGuestSevenMute.setVisibility(View.GONE);
                        clicked = false;
                    ...
                    case 8:
                        rlGuestEightGoldLayout.setVisibility(View.GONE);
                        sendChannelMessage(removeGuestId + level + SessionUser.getUser().getName() + " Guest Eight Left the Broadcast");
                        rlGuestEightMute.setVisibility(View.GONE);
                        clicked = false;
    ...
    private void callRemoveImageAPI() {
        ...
        if (isBroadcastEnded) {
            ...
            utils.hideProgress();
            Intent intent = new Intent(ActivityGroupCalls9.this, ActivityBroadcastStop.class);
...
//                runOnUiThread(this::callAPIOffline);
    ...
    private void switchToDefaultVideoView(ArrayList<Audience> guests) {
        ...
        mGridVideoViewContainer9.initViewContainer(getApplicationContext(), broadcaster.getId(), mUidsList, false, isBroadcaster, guests);
                        ...
                        if (response.code() == 200) {
                            if (usersResponse != null) {
                                if (usersResponse.getStatus().equalsIgnoreCase("success")) {
                                    ...
                                    tvConnectingguestSix.setVisibility(View.GONE);
                                    tvConnectingguestSeven.setVisibility(View.GONE);
                                    tvConnectingguestEight.setVisibility(View.GONE);
    ...
    private void setGifGift(Gift gift, String giftMessage) {
        ...
        if (fileNew.exists()) {
            ...
            if (gift.getType().equalsIgnoreCase("normal")) {
                ...
                if (isGuest6) {
                    isGuestAvailable = true;
                    if (sendId.equals(guestSix.getUser_id())) {
                        ivGuestSixSmallGift.setVisibility(View.VISIBLE);
                        Glide.with(getApplicationContext())
                                .load(fileNew)
                                .addListener(new RequestListener<Drawable>() {
                                    @Override
                                ...
                                }).into(ivGuestSixSmallGift);
                    }
                }
                if (isGuest7) {
                    isGuestAvailable = true;
                    if (sendId.equals(guestSeven.getUser_id())) {
                        ivGuestSevenSmallGift.setVisibility(View.VISIBLE);
                        Glide.with(getApplicationContext())
                                .load(fileNew)
                                .addListener(new RequestListener<Drawable>() {
                                    @Override
                                ...
                                }).into(ivGuestSevenSmallGift);
                    }
                }
                if (isGuest8) {
                    isGuestAvailable = true;
                    if (sendId.equals(guestEight.getUser_id())) {
                        ivGuestEightSmallGift.setVisibility(View.VISIBLE);
                        Glide.with(getApplicationContext())
                                .load(fileNew)
                                .addListener(new RequestListener<Drawable>() {
                                    @Override
    ...
    public void onAcceptRequest(Audience user, int position) {
        if (!isGuest1 || !isGuest2 || !isGuest3 || !isGuest4 || !isGuest5 || !isGuest6 || !isGuest7 || !isGuest8) {
            if (isAcceptRequest) {
    ...
    private void callAlertKickOut() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ActivityGroupCalls9.this);
    ...
    public void onRemoveGuestSuccess(ArrayList<Audience> users) {
        mGuests.clear();
        mGuests = users;
        //sendChannelMessage( "load guest list");
        if (isClose) {
            callRemoveImageAPI();
            Constants_app.cleanMessageListBeanList();
            finish();
    ...
    private void onMessageReceive(final RtmMessage text, final RtmChannelMember fromMember) {
        runOnUiThread(() -> {
            ...
            if (!account.equals(selfName)) {
                if (msg.contains("Broadcaster has accepted your broadcast request")) {
                ...
                } else if (msg.contains("Guest Six Removed")) {
                    String id = msg.substring(0, 6);
                    if (SessionUser.getUser().getUser_id().equals(id)) {
                        isGuest = false;
                        doSwitchToBroadcaster(false);
                    }
                } else if (msg.contains("Guest Seven Removed")) {
                    String id = msg.substring(0, 6);
                    if (SessionUser.getUser().getUser_id().equals(id)) {
                        isGuest = false;
                        doSwitchToBroadcaster(false);
                    }
                } else if (msg.contains("Guest Eight Removed")) {
                    String id = msg.substring(0, 6);
                    if (SessionUser.getUser().getUser_id().equals(id)) {
                        isGuest = false;
                        doSwitchToBroadcaster(false);
                ...
                } else if (msg.contains("guestSix")) {
                    String message = msg.replace("guestSix", "");
                    flGuestSixFrame.setVisibility(View.VISIBLE);
                    tvGuestSixGold.setText(message);
                } else if (msg.contains("guestSeven")) {
                    String message = msg.replace("guestSeven", "");
                    flGuestSevenFrame.setVisibility(View.VISIBLE);
                    tvGuestSevenGold.setText(message);
                } else if (msg.contains("guestEight")) {
                    String message = msg.replace("guestEight", "");
                    flGuestEightFrame.setVisibility(View.VISIBLE);
                    tvGuestEightGold.setText(message);
                    ...
                    rlGuestFiveMute.setVisibility(View.GONE);
                } else if (msg.contains(" GuestSix Muted")) {
                    rlGuestSixMute.setVisibility(View.VISIBLE);
                } else if (msg.contains(" GuestSix UnMuted")) {
                    rlGuestSixMute.setVisibility(View.GONE);
                } else if (msg.contains(" GuestSeven Muted")) {
                    rlGuestSevenMute.setVisibility(View.VISIBLE);
                } else if (msg.contains(" GuestSeven UnMuted")) {
                    rlGuestSevenMute.setVisibility(View.GONE);
                } else if (msg.contains(" GuestEight Muted")) {
                    rlGuestEightMute.setVisibility(View.VISIBLE);
                } else if (msg.contains(" GuestEight UnMuted")) {
                    rlGuestEightMute.setVisibility(View.GONE);
...
//                        callGetGuestsAPI();
    ...
    class LikeAnimationViewProvider implements LikeAnimationView.Provider {
        ...
        public Bitmap getBitmap(Object obj) {
            return ActivityGroupCalls9.this.mAnimationItemList == null ? null : (Bitmap) ActivityGroupCalls9.this.mAnimationItemList.get((Integer) obj);
        }
    }
    ...
    private void callStatusAPI() {
        ...
        if (utils.isNetworkAvailable()) {
            ...
            final ApiInterface apiClient = ApiClientBase.getClient().create(ApiInterface.class);
            Call<GenericResponse> call = apiClient.goLive(SessionUser.getUser().getUser_id(), "INACTIVE", "groupof9",
    ...
    public void onGiftSuccess(String userId, String guestGoldValue, String currentGoldValue, String moonLevel, String moonValue, String giftname) {
        ...
        switch (giftSendTo) {
            ...
            case "guestFive":
                ...
                break;
            case "guestSix":
                tvGuestSixGold.setText(guestGoldValue);
                break;
            case "guestSeven":
                tvGuestSevenGold.setText(guestGoldValue);
                break;
            case "guestEight":
                tvGuestEightGold.setText(guestGoldValue);
                break;
            case "broadcaster":
        ...
        switch (giftSendTo) {
            ...
            case "guestFive":
                ...
                break;
            case "guestSix":
                messageText = userId + level + SessionUser.getUser().getName() + " : Has sent gIfTsEnTtOyOU " + giftname + " to " + guestSix.getName() + multiplier;
                break;
            case "guestSeven":
                messageText = userId + level + SessionUser.getUser().getName() + " : Has sent gIfTsEnTtOyOU " + giftname + " to " + guestSeven.getName() + multiplier;
                break;
            case "guestEight":
                messageText = userId + level + SessionUser.getUser().getName() + " : Has sent gIfTsEnTtOyOU " + giftname + " to " + guestEight.getName() + multiplier;
                break;
            case "broadcaster":
...
//                    .into(ivEffect);
                    ...
                    if (!isGuest1 || !isGuest2 || !isGuest3 || !isGuest4 || !isGuest5 || !isGuest6 || !isGuest7 || !isGuest8) {
                        ...
                        if (!isExits) {
                            ...
                            if (!isGuest1) {
                                ...
                                tvConnectingguestSix.setVisibility(View.VISIBLE);
                            } else if (!isGuest4) {
                                tvConnectingguestSeven.setVisibility(View.VISIBLE);
                            } else if (!isGuest5) {
                                tvConnectingguestEight.setVisibility(View.VISIBLE);
                            }
                        } else
            ...
            llKickOut.setOnClickListener(v -> {
                if (tvProfile.getText().toString().equals("Profile")) {
                    ...
                    adapter.notifyItemRangeChanged(messageBeanList.size(), 1);
                    rvMessages.scrollToPosition(messageBeanList.size() - 1);
                    Log.e(TAG, "KICKOUT: " + audience.getUser_id() + level + audience.getName());
            ...
            rlReport.setOnClickListener(v -> {
                ...
                LayoutInflater layoutInflater = LayoutInflater.from(ActivityGroupCalls9.this);
                final View dialogView = layoutInflater.inflate(R.layout.pop_up_report, null);
                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ActivityGroupCalls9.this);
            ...
            llTopFans.setOnClickListener(v -> {
                Intent intent = new Intent(ActivityGroupCalls9.this, ActivityTopFans.class);
    ...
    public void gotoProfile(String image, String userId) {
        Intent intent = new Intent(ActivityGroupCalls9.this, ActivityViewProfile.class);
        intent.putExtra("image", image);
    ...
    public void onGuestSixClicked(View view) {
        if (isGiftSelected) {
            if (isGuest6) {
                giftSendTo = "guestSix";
                if (SessionUser.getUser().getUser_id().equals(guestSix.getUser_id())) {
                    showToast("Can't send gift to yourself");
                } else {
                    if (isGuest6) {
                        apiGiftSendToGuest(guestSix.getUser_id());
                    }
                }
            }
        } else {
            if (isGuest6) {
                showGuestProfile(guestSix, 6);
            }
        }
    }

    public void onGuestSevenClicked(View view) {
        if (isGiftSelected) {
            if (isGuest7) {
                giftSendTo = "guestSeven";
                if (SessionUser.getUser().getUser_id().equals(guestSeven.getUser_id())) {
                    showToast("Can't send gift to yourself");
                } else {
                    if (isGuest7) {
                        apiGiftSendToGuest(guestSeven.getUser_id());
                    }
                }
            }
        } else {
            if (isGuest7) {
                showGuestProfile(guestSeven, 7);
            }
        }
    }

    public void onGuestEightClicked(View view) {
        if (isGiftSelected) {
            if (isGuest8) {
                giftSendTo = "guestEight";
                if (SessionUser.getUser().getUser_id().equals(guestEight.getUser_id())) {
                    showToast("Can't send gift to yourself");
                } else {
                    if (isGuest8) {
                        apiGiftSendToGuest(guestEight.getUser_id());
                    }
                }
            }
        } else {
            if (isGuest8) {
                showGuestProfile(guestEight, 8);
            }
        }
    }
    ...
    public void onGuestSixGoldClicked(View view) {
        if (isGuest2) {
            if (!isProfileShowing)
                isProfileShowing = true;
    ...
    public void onGuestSevenGoldClicked(View view) {
        if (isGuest2) {
            if (!isProfileShowing)
                isProfileShowing = true;
    ...
    public void onGuestEightGoldClicked(View view) {
        if (isGuest2) {
            if (!isProfileShowing)
                isProfileShowing = true;
    ...
    public void guestGoldTopperDetails(String overAllGold, String profilePic, String userid, String name) {
        ...
        BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(ActivityGroupCalls9.this);
    ...
    public void loadGuestDetails(ArrayList<Audience> users) {
        ...
        if (users.size() > 0) {
            ...
            if (users.size() == 1) {
                ...
                tvGuestSixGold.setText(guestSix.getOver_all_gold());
                tvGuestSevenGold.setText(guestSeven.getOver_all_gold());
                tvGuestEightGold.setText(guestEight.getOver_all_gold());
                ...
                rlGuestSixGoldLayout.setVisibility(View.VISIBLE);
                rlGuestSevenGoldLayout.setVisibility(View.VISIBLE);
                rlGuestEightGoldLayout.setVisibility(View.VISIBLE);
                ...
                if (SessionUser.getUser().getUser_id().equals(guestOne.getUser_id())) {
                    ...
                    isThisGuest7 = true;
                    loadStarImage(guestSeven.getOver_all_gold());
                } else if (SessionUser.getUser().getUser_id().equals(guestEight.getUser_id())) {
                    isThisGuest8 = true;
                    loadStarImage(guestEight.getOver_all_gold());
                }
            }
        } else {
            ivGift.setVisibility(View.VISIBLE);
            ...
            tvGuestSixGold.setText("");
            tvGuestSevenGold.setText("");
            tvGuestEightGold.setText("");
        ...
        if (isGuest) {
            if (isGuest1 || isGuest2 || isGuest3 || isGuest4 || isGuest5 || isGuest6 || isGuest7 || isGuest8) {
                if (SessionUser.getUser().getUser_id().equals(guestOne.getUser_id())) {
                    ...
                    if (isGuest8) {
                        guestGoldTopperDetails(guestEight.getOver_all_gold(),
                                guestEight.getProfile_pic(), guestEight.getUser_id(), guestEight.getName());
                    }
                }
            } else {
                guestGoldTopperDetails(tvBroadcastGold.getText().toString(),
    ...
    private void callGuestVideoMute() {
        if (isGuest1 || isGuest2 || isGuest3 || isGuest4 || isGuest5 || isGuest6 || isGuest7 || isGuest8) {
            ...
            if (isGuest6) {
                if (SessionUser.getUser().getUser_id().equals(guestSix.getUser_id())) {
                    if (isGuestVideoMuted) {
                        callVideoMuteAPI(guestSix.getUser_id(), broadcaster.getUser_id(), "no");
                        isGuestVideoMuted = false;
                        ivVideoMute.setBackground(getResources().getDrawable(R.mipmap.videomute));
                        worker().getRtcEngine().muteLocalVideoStream(false);
                        if (!flag)
                            worker().getRtcEngine().muteLocalAudioStream(false);
                        sendChannelMessage(SessionUser.getUser().getUser_id() + level + SessionUser.getUser().getName() + " GuestSix UnMuted");
                        rlGuestSixMute.setVisibility(View.GONE);
                    } else {
                        callVideoMuteAPI(guestSix.getUser_id(), broadcaster.getUser_id(), "yes");
                        isGuestVideoMuted = true;
                        ivVideoMute.setBackground(getResources().getDrawable(R.mipmap.video_unmute));
                        worker().getRtcEngine().muteLocalVideoStream(true);
                        if (!flag)
                            worker().getRtcEngine().muteLocalAudioStream(false);
                        sendChannelMessage(SessionUser.getUser().getUser_id() + level + SessionUser.getUser().getName() + " GuestSix Muted");
                        rlGuestSixMute.setVisibility(View.VISIBLE);
                    }
                }
            }
            if (isGuest7) {
                if (SessionUser.getUser().getUser_id().equals(guestSeven.getUser_id())) {
                    if (isGuestVideoMuted) {
                        callVideoMuteAPI(guestSeven.getUser_id(), broadcaster.getUser_id(), "no");
                        isGuestVideoMuted = false;
                        ivVideoMute.setBackground(getResources().getDrawable(R.mipmap.videomute));
                        worker().getRtcEngine().muteLocalVideoStream(false);
                        if (!flag)
                            worker().getRtcEngine().muteLocalAudioStream(false);
                        sendChannelMessage(SessionUser.getUser().getUser_id() + level + SessionUser.getUser().getName() + " GuestSeven UnMuted");
                        rlGuestSevenMute.setVisibility(View.GONE);
                    } else {
                        callVideoMuteAPI(guestSeven.getUser_id(), broadcaster.getUser_id(), "yes");
                        isGuestVideoMuted = true;
                        ivVideoMute.setBackground(getResources().getDrawable(R.mipmap.video_unmute));
                        worker().getRtcEngine().muteLocalVideoStream(true);
                        if (!flag)
                            worker().getRtcEngine().muteLocalAudioStream(false);
                        sendChannelMessage(SessionUser.getUser().getUser_id() + level + SessionUser.getUser().getName() + " GuestSeven Muted");
                        rlGuestSevenMute.setVisibility(View.VISIBLE);
                    }
                }
            }
            if (isGuest8) {
                if (SessionUser.getUser().getUser_id().equals(guestEight.getUser_id())) {
                    if (isGuestVideoMuted) {
                        callVideoMuteAPI(guestEight.getUser_id(), broadcaster.getUser_id(), "no");
                        isGuestVideoMuted = false;
                        ivVideoMute.setBackground(getResources().getDrawable(R.mipmap.videomute));
                        worker().getRtcEngine().muteLocalVideoStream(false);
                        if (!flag)
                            worker().getRtcEngine().muteLocalAudioStream(false);
                        sendChannelMessage(SessionUser.getUser().getUser_id() + level + SessionUser.getUser().getName() + " GuestEight UnMuted");
                        rlGuestEightMute.setVisibility(View.GONE);
                    } else {
                        callVideoMuteAPI(guestEight.getUser_id(), broadcaster.getUser_id(), "yes");
                        isGuestVideoMuted = true;
                        ivVideoMute.setBackground(getResources().getDrawable(R.mipmap.video_unmute));
                        worker().getRtcEngine().muteLocalVideoStream(true);
                        if (!flag)
                            worker().getRtcEngine().muteLocalAudioStream(false);
                        sendChannelMessage(SessionUser.getUser().getUser_id() + level + SessionUser.getUser().getName() + " GuestEight Muted");
                        rlGuestEightMute.setVisibility(View.VISIBLE);
                    }
                }
            }
                ...
                if (!clicked)
                    ...
                    if (!clicked)
                        ...
                        if (!clicked)
                            ...
                            else if (isThisGuest6)
                                if (!clicked)

                                    removeGuestApi(SessionUser.getUser().getUser_id(), true, false, 6);
                                else if (isThisGuest7)
                                    if (!clicked)

                                        removeGuestApi(SessionUser.getUser().getUser_id(), true, false, 7);
                                    else if (isThisGuest8)
                                        if (!clicked)

                                            removeGuestApi(SessionUser.getUser().getUser_id(), true, false, 8);
    }
...
//        }
    ...
    public void onClickShare(View view) {
        fabMenu.close(true);
        showSharingDialog(ActivityGroupCalls9.this);
    }
...
//                                "\"iOS: https://apps.apple.com/us/app/blive24hrs/id1459884150\n" +
    ...
    public void showNotification() {
        notificationManager = NotificationManagerCompat.from(ActivityGroupCalls9.this);
        createNotificationChannel();

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {

            mBuilder = new NotificationCompat.Builder(ActivityGroupCalls9.this, CHANNEL_ID)
            ...
            mBuilder = new NotificationCompat.Builder(ActivityGroupCalls9.this)
                    .setSmallIcon(R.mipmap.ic_launcher)
                    .setContentTitle("Broadcast Still Streaming ")
                    .setStyle(new NotificationCompat.BigTextStyle()
                            .bigText("Your broadcast has paused!"))
