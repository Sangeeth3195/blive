...
import com.blive.R;
import com.blive.agora.popup.BasePopupWindow;
import com.blive.agora.popup.ItemClickHandler;
...
public class FaceBeautificationPopupWindow extends BasePopupWindow {
    ...
    public FaceBeautificationPopupWindow(Context ctx) {
        ...
        fbSwitch.setChecked(Constants_app.BEAUTY_EFFECT_ENABLED);
        ...
        lightnessSeekBar.setMax((int) (Constants_app.BEAUTY_EFFECT_MAX_LIGHTNESS * 100.f));
        lightnessSeekBar.setProgress((int) (Constants_app.BEAUTY_OPTIONS.lighteningLevel * 100.f));
        final TextView lightnessValueView = (TextView) contentView.findViewById(R.id.set_lightness_label);
        lightnessValueView.setText(mCtx.getString(R.string.label_lightness) + " " + Constants_app.BEAUTY_OPTIONS.lighteningLevel);
        ...
        smoothnessSeekBar.setMax((int) (Constants_app.BEAUTY_EFFECT_MAX_SMOOTHNESS * 100.f));
        smoothnessSeekBar.setProgress((int) (Constants_app.BEAUTY_OPTIONS.smoothnessLevel * 100.f));
        final TextView smoothnessValueView = (TextView) contentView.findViewById(R.id.set_smoothness_label);
        smoothnessValueView.setText(mCtx.getString(R.string.label_smoothness) + " " + Constants_app.BEAUTY_OPTIONS.smoothnessLevel);
        ...
        ctSeekBar.setMax((int) (Constants_app.BEAUTY_EFFECT_MAX_REDNESS * 100.f));
        ctSeekBar.setProgress((int) (Constants_app.BEAUTY_OPTIONS.rednessLevel * 100.f));
        final TextView rednessValueView = (TextView) contentView.findViewById(R.id.set_redness_label);
        rednessValueView.setText(mCtx.getString(R.string.label_redness) + " " + Constants_app.BEAUTY_OPTIONS.rednessLevel);
