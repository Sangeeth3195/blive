...
public:
    ...
    {
        string msg_prefix = "start to onCaptureVideoFrame,rotation:";
        string msg =  msg_prefix + to_string(videoFrame.rotation);
        writeLog(msg.c_str());
        ...
        (JNIEnv *env, jobject obj, jboolean enable)
{
    ...
    renderClass = env->FindClass("com/blive/agora/AGRender");
